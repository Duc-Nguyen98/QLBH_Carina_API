app.controller('mycontroller', ['$scope', function ($scope) {
    ...
    // tạo mới khách hàng gọi đến angular khách hàng + hàm validate 
    $scope.Taomoikh = function () {
        $("#personal-create-info-kh").validate({
            rules: {
                email: {
                    required: true,
                    email: true
